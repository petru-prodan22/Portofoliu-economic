...
% =========================================================================
rng('shuffle'); 
opts = detectImportOptions('Date_companii_1y.csv');
opts.VariableNamingRule = 'preserve';
dataTab = readtable('Date_companii_1y.csv', opts);
...
for i = 1:numPoints
    ...
    % --- MODIFICAT AICI: Folosim trainReturns brut pentru a calcula Sortino Ratio
...
% --- MODIFICAT AICI: Folosim trainReturns brut
